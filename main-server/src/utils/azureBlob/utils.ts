...
AccountName=nikkiazure;
AccountKey=AcbLSuihenrhewhye8t5uhy59t4uy9biru9oeijgtrvisjrohyijseroiyjijghsrtjhijthrknPXX+AStShGsHQ==;
EndpointSuffix=core.windows.net
"
*/

export const extractConnectionStringParts = (connectionString: string) => {
  ...
  parts.forEach((part) => {
    ...
    } else if (part.includes("EndpointSuffix")) {
      url = part.split("=")[1];
    }
  });

  return { accountKey, accountName, url };
};
